  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-test_color dark:bg-background">
      ...
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        ...
        you're on your way to JotGenius!
      </p>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <button
          className="relative group/btn bg-gradient-to-br from-background to-gradient-1 dark:from-gradient-0 dark:via-purple-700 dark:to-gradient-1 block w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
          type="submit"
        >
          Login
          <BottomGradient />
